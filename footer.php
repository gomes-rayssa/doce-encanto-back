      ...
      <div class="footer-content">
        <div class="footer-section">
          ...
          <p class="footer-description">
            Criando momentos doces e inesquecíveis desde 2020. Sabor e beleza
            em cada mordida.
          </p>
          <div class="footer-social" role="navigation" aria-label="Redes sociais">
            <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Facebook - abre em nova janela">
