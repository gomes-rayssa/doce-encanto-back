      ...
      <form id="registration-form" aria-labelledby="form-title">
        <div class="form-step active" id="step1">
          ...
          <div class="form-group">
            ...
            <input type="tel" id="celular" name="celular" placeholder="(00) 90000-0000" required aria-required="true"
              aria-describedby="celular-error" autocomplete="tel" />
            <span class="error-message" id="celular-error" role="alert" aria-live="polite"></span>
          </div>

          <div class="form-group">
            <label for="data-nascimento">Data de Nascimento</label>
            <input type="date" id="data-nascimento" name="data-nascimento" required aria-required="true"
              aria-describedby="data-nascimento-error" autocomplete="bday" />
          ...
          <div class="form-group">
            ...
            <div class="password-container">
              <input type="password" id="confirmar-senha" name="confirmar-senha" required aria-required="true"
        ...
        <div class="form-step" id="step2" aria-hidden="true">
          ...
          <div class="form-group">
            ...
            <input type="text" id="cep" name="cep" placeholder="00000-000" required aria-required="true"
              aria-describedby="cep-error" autocomplete="postal-code" />
            <span class="error-message" id="cep-error" role="alert" aria-live="polite"></span>
          </div>

          <div class="form-group">
            <label for="rua">Rua</label>
            <input type="text" id="rua" name="rua" required aria-required="true" aria-describedby="rua-error"
          ...
          <div class="form-group">
            ...
            <input type="text" id="numero" name="numero" required aria-required="true"
          ...
          <div class="form-group">
            ...
            <input type="text" id="bairro" name="bairro" required aria-required="true" aria-describedby="bairro-error"
          ...
          <div class="form-group">
            ...
            <input type="text" id="cidade" name="cidade" required aria-required="true" aria-describedby="cidade-error"
              autocomplete="address-level2" />
