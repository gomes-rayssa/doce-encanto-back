...
<div class="carrinho-container">
            ...
            <?php foreach ($carrinho as $id => $item): ?>
                ...
                <li class="item-carrinho" data-id="<?php echo $id; ?>">
                    <div class="item-imagem">
                        <img src="<?php echo htmlspecialchars($item['imagem'] ?? '../assets/logos/logo-navbar.jpg'); ?>" alt="<?php echo htmlspecialchars($item['nome']); ?>" />
                    </div>
                    <div class="item-info">
                    ...
                    <div class="item-quantidade">
                        <button onclick="alterarQuantidade('<?php echo $id; ?>', <?php echo $item['quantidade'] - 1; ?>)" class="btn-quantidade">-</button>
    ...
    <div class="carrinho-resumo">
        <div class="carrinho-total">Total: R$ <span id="total"><?php echo number_format($total, 2, ',', '.'); ?></span></div>
