...
<main id="main-content">
    ...
    <div class="carrinho-container">
            ...
            <?php else: ?>
                <?php foreach ($carrinho as $id => $item): ?>
                    ...
                    <li class="item-carrinho" data-id="<?php echo $id; ?>" role="listitem">
                        ...
                        <div class="item-quantidade" role="group"
                            aria-label="Quantidade de <?php echo htmlspecialchars($item['nome']); ?>">
                            <button onclick="alterarQuantidade('<?php echo $id; ?>', <?php echo $item['quantidade'] - 1; ?>)"
                                class="btn-quantidade"
                                aria-label="Diminuir quantidade de <?php echo htmlspecialchars($item['nome']); ?>">-</button>
                            <span class="quantidade"
                                aria-label="Quantidade atual: <?php echo $item['quantidade']; ?>"><?php echo $item['quantidade']; ?></span>
                            <button onclick="alterarQuantidade('<?php echo $id; ?>', <?php echo $item['quantidade'] + 1; ?>)"
                                class="btn-quantidade"
                                aria-label="Aumentar quantidade de <?php echo htmlspecialchars($item['nome']); ?>">+</button>
                        </div>
                        <div class="item-total">
                            <p aria-label="Subtotal: R$ <?php echo number_format($subtotal, 2, ',', '.'); ?>">R$
        ...
        <aside class="carrinho-resumo" role="complementary" aria-labelledby="resumo-title">
            <div class="carrinho-total" id="resumo-title">Total: R$ <span
                    id="total"><?php echo number_format($total, 2, ',', '.'); ?></span>
            </div>
    ...
    <div id="modal-pagamento" class="modal-pagamento" role="dialog" aria-labelledby="modal-pagamento-title"
        ...
        <div class="modal-pagamento-content">
            ...
            <h2 id="modal-pagamento-title"><i class="fas fa-credit-card" aria-hidden="true"></i> Finalizar Pagamento
            </h2>
                ...
                <fieldset id="dados-cartao" class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="numero-cartao" name="numero-cartao" placeholder="0000 0000 0000 0000"
                            maxlength="19" required aria-required="true" autocomplete="cc-number">
